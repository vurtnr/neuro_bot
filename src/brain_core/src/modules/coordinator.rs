                ...
                match serde_json::from_str::<LlmResponse>(json_str) {
                    Ok(llm_resp) => {
                        ...
                        match llm_resp.r#type.as_str() {
                            ...
                            // 🦾 【分支 B：控制自身肢体】
                            "action" => match llm_resp.cmd.as_str() {
                                "WAVE" => {
                                    actions.push(Action::BodyMove {
                                        cmd: "WAVE".to_string(),
                                        params: "".to_string(),
                                    });
                                }
                                "GIMBAL" => {
                                    ...
                                    actions.push(Action::BodyMove {
                                        cmd: "GIMBAL".to_string(),
                                        params: target_angle.to_string(),
                                    });
                                }
                                _ => {}
                            },
